...
public  final class RequestGetTeas extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return UserCenterProto.internal_static_custom_proto_RequestGetTeas_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return UserCenterProto.internal_static_custom_proto_RequestGetTeas_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            RequestGetTeas.class, RequestGetTeas.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof RequestGetTeas)) {
      return super.equals(obj);
    }
    RequestGetTeas other = (RequestGetTeas) obj;
  ...
  public static RequestGetTeas parseFrom(
  ...
  public static RequestGetTeas parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static RequestGetTeas parseFrom(
  ...
  public static RequestGetTeas parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static RequestGetTeas parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static RequestGetTeas parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(RequestGetTeas prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using RequestGetTeas.newBuilder()
    private Builder() {
    ...
    public RequestGetTeas getDefaultInstanceForType() {
      return RequestGetTeas.getDefaultInstance();
    }

    public RequestGetTeas build() {
      RequestGetTeas result = buildPartial();
    ...
    public RequestGetTeas buildPartial() {
      RequestGetTeas result = new RequestGetTeas(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof RequestGetTeas) {
        return mergeFrom((RequestGetTeas)other);
      } else {
    ...
    public Builder mergeFrom(RequestGetTeas other) {
      if (other == RequestGetTeas.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      RequestGetTeas parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (RequestGetTeas) e.getUnfinishedMessage();
  ...
  private static final RequestGetTeas DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new RequestGetTeas();
  }

  public static RequestGetTeas getDefaultInstance() {
