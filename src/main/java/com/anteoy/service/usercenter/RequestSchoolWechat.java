...
public  final class RequestSchoolWechat extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return UserCenterProto.internal_static_custom_proto_RequestSchoolWechat_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return UserCenterProto.internal_static_custom_proto_RequestSchoolWechat_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            RequestSchoolWechat.class, RequestSchoolWechat.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof RequestSchoolWechat)) {
      return super.equals(obj);
    }
    RequestSchoolWechat other = (RequestSchoolWechat) obj;
  ...
  public static RequestSchoolWechat parseFrom(
  ...
  public static RequestSchoolWechat parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static RequestSchoolWechat parseFrom(
  ...
  public static RequestSchoolWechat parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static RequestSchoolWechat parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static RequestSchoolWechat parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(RequestSchoolWechat prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using RequestSchoolWechat.newBuilder()
    private Builder() {
    ...
    public RequestSchoolWechat getDefaultInstanceForType() {
      return RequestSchoolWechat.getDefaultInstance();
    }

    public RequestSchoolWechat build() {
      RequestSchoolWechat result = buildPartial();
    ...
    public RequestSchoolWechat buildPartial() {
      RequestSchoolWechat result = new RequestSchoolWechat(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof RequestSchoolWechat) {
        return mergeFrom((RequestSchoolWechat)other);
      } else {
    ...
    public Builder mergeFrom(RequestSchoolWechat other) {
      if (other == RequestSchoolWechat.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      RequestSchoolWechat parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (RequestSchoolWechat) e.getUnfinishedMessage();
  ...
  private static final RequestSchoolWechat DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new RequestSchoolWechat();
  }

  public static RequestSchoolWechat getDefaultInstance() {
