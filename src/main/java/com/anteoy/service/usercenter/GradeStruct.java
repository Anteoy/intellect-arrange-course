...
public  final class GradeStruct extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return UserCenterProto.internal_static_custom_proto_GradeStruct_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return UserCenterProto.internal_static_custom_proto_GradeStruct_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GradeStruct.class, GradeStruct.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    GradeStruct other = (GradeStruct) obj;
  ...
  public static GradeStruct parseFrom(
  ...
  public static GradeStruct parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GradeStruct parseFrom(
  ...
  public static GradeStruct parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GradeStruct parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GradeStruct parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GradeStruct prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using GradeStruct.newBuilder()
    private Builder() {
    ...
    public GradeStruct getDefaultInstanceForType() {
      return GradeStruct.getDefaultInstance();
    }

    public GradeStruct build() {
      GradeStruct result = buildPartial();
    ...
    public GradeStruct buildPartial() {
      GradeStruct result = new GradeStruct(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GradeStruct) {
        return mergeFrom((GradeStruct)other);
      } else {
    ...
    public Builder mergeFrom(GradeStruct other) {
      if (other == GradeStruct.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GradeStruct parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GradeStruct) e.getUnfinishedMessage();
  ...
  private static final GradeStruct DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GradeStruct();
  }

  public static GradeStruct getDefaultInstance() {
