...
public final class JRServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.class100.sample.SingerId,
      com.class100.sample.SongList> METHOD_LIST_SONGS =
      io.grpc.MethodDescriptor.<com.class100.sample.SingerId, com.class100.sample.SongList>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "JRService.JRService", "ListSongs"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.class100.sample.SingerId.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.class100.sample.SongList.getDefaultInstance()))
          .setSchemaDescriptor(new JRServiceMethodDescriptorSupplier("ListSongs"))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.class100.sample.SingerId,
      com.class100.sample.Song> METHOD_GET_SONGS =
      io.grpc.MethodDescriptor.<com.class100.sample.SingerId, com.class100.sample.Song>newBuilder()
          ...
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.class100.sample.SingerId.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.class100.sample.Song.getDefaultInstance()))
  ...
  public static abstract class JRServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void listSongs(com.class100.sample.SingerId request,
        io.grpc.stub.StreamObserver<com.class100.sample.SongList> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_LIST_SONGS, responseObserver);
    }

    /**
     */
    public void getSongs(com.class100.sample.SingerId request,
        io.grpc.stub.StreamObserver<com.class100.sample.Song> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.class100.sample.SingerId,
                com.class100.sample.SongList>(
  ...
  public static final class JRServiceBlockingStub extends io.grpc.stub.AbstractStub<JRServiceBlockingStub> {
    ...
    /**
     */
    public com.class100.sample.SongList listSongs(com.class100.sample.SingerId request) {
    ...
    /**
     */
    public java.util.Iterator<com.class100.sample.Song> getSongs(
        com.class100.sample.SingerId request) {
  ...
  public static final class JRServiceFutureStub extends io.grpc.stub.AbstractStub<JRServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.class100.sample.SongList> listSongs(
        com.class100.sample.SingerId request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_SONGS:
          serviceImpl.listSongs((com.class100.sample.SingerId) request,
              (io.grpc.stub.StreamObserver<com.class100.sample.SongList>) responseObserver);
          break;
        case METHODID_GET_SONGS:
          serviceImpl.getSongs((com.class100.sample.SingerId) request,
              (io.grpc.stub.StreamObserver<com.class100.sample.Song>) responseObserver);
          break;
        default:
  ...
  private static abstract class JRServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.class100.sample.JRProto.getDescriptor();
    }
